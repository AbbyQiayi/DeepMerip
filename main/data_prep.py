...
def main():
    path_to_data_dir = "../data/exomePeak2_out/HEK293"  # Path to the raw data
    save_data_path = "../data/dataset"  # Path to save processed datasets

    # Define the cell lines and down-sampling extensions to process
    cell_lines = ['SYSY'] # change to your own cell line
    extensions = ['0.01dn','0.02dn','0.03dn'] # change to your own downsample rate
