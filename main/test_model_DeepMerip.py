...
from Deep_merip import MultiTaskModel  # Assuming this is your custom model
...
downsamples = ['0.01dn', '0.02dn', '0.03dn', '0.05dn', '0.1dn'] # change it with your down sample rate
test_cell_lines = ['NEB'] # change it with your test cell line
...
for downsample in downsamples:
    for test_cell_line in test_cell_lines:
        ...
        model_save_path = f'../model/deepmerip_model_{downsample}.pth'  # Path to the saved model
